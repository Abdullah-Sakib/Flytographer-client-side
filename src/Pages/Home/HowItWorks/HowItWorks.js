...
const HowItWorks = () => {
  return (
    <div className="pt-4">
      <h1 className='text-4xl font-bold flex items-center justify-start ml-8 mb-7'><BsCameraFill className='mr-4 text-indigo-300 text-5xl'></BsCameraFill> How it works?</h1>
